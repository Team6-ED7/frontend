            ...
            <nav className='py-4 md:px-8 px-4 bg-white ${isSticky ? "sticky top-0 right-0 left-0 bg-white" : "" } '>
                <div className='flex items-center justify-between '>
                    ...
                    <div className='lg:flex items-center gap-3 hidden text-stone-950'>
                        <Link to='/' className='block hover:underline py-2 px-4'>Encuentra una ubicación</Link>
                        <Link to='/' className='block hover:underline py-2 px-4'>Soluciones</Link>
                        <Link to='/' className='block hover:underline py-2 px-4'>Enterprise</Link>
                        <Link to='/' className='block hover:underline py-2 px-4'>Inicio de Sesion de Miembros </Link>
                    </div>
                    {/*Boton de uneteya!*/}
